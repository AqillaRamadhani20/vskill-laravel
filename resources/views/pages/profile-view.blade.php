                ...
                @forelse($user->portfolios as $portfolio)
                    <div class="pv-portfolio-card">
                        ...
                        <div class="pv-portfolio-content">
                            ...
                            @if($portfolio->link_demo)
                                @php
                                    $linkLabel = 'Lihat Bukti / Demo';
                                    if (str_contains($portfolio->link_demo, 'drive.google.com')) {
                                        $linkLabel = 'Lihat Sertifikat (Google Drive)';
                                    } elseif (str_contains($portfolio->link_demo, 'github.com')) {
                                        $linkLabel = 'Lihat Repository (GitHub)';
                                    } elseif (str_contains($portfolio->link_demo, 'figma.com')) {
                                        $linkLabel = 'Lihat Desain (Figma)';
                                    }
                                @endphp
