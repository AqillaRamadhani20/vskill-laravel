...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $sql = <<<'SQL'
INSERT IGNORE INTO `orders` (`id`, `service_id`, `buyer_id`, `seller_id`, `no_wa`, `catatan`, `status`, `created_at`) VALUES
...
INSERT IGNORE INTO `portfolio` (`id`, `user_id`, `judul_project`, `deskripsi`, `tools`, `link_demo`, `created_at`) VALUES
...
INSERT IGNORE INTO `profiles` (`id`, `user_id`, `npm`, `prodi`, `foto`, `bio`, `skill_summary`, `tools_summary`, `harga_mulai`, `kontak_wa`, `status_ketersediaan`) VALUES
...
INSERT IGNORE INTO `services` (`id`, `user_id`, `judul_jasa`, `kategori`, `deskripsi`, `harga`, `estimasi_pengerjaan`, `status`, `created_at`) VALUES
...
INSERT IGNORE INTO `users` (`id`, `nama_lengkap`, `email`, `username`, `password`, `role`, `is_verified`, `created_at`) VALUES
...
SQL;
        ...
        // Users wajib dimasukkan dulu karena tabel lain punya foreign key.
        $statements = preg_split('/;\s*/', $sql, -1, PREG_SPLIT_NO_EMPTY);

        usort(
            $statements,
            fn($a, $b) => str_contains($b, '`users`') <=> str_contains($a, '`users`')
        );
        ...
        // Admin user — dibuat via Eloquent agar password di-hash dengan benar
